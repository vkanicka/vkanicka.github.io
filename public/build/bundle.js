...
var app = (function () {
    ...
    function create_else_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t = text(t_value);
    			attr_dev(button, "class", "alphi baseline svelte-g3rz42");
    			add_location(button, file, 92, 8, 2417);
    		},
    ...
    // (82:6) {#if guessBoard[0].indexOf(letter) >= 0 || guessBoard[1].indexOf(letter) >= 0 || guessBoard[2].indexOf(letter) >= 0 || guessBoard[3].indexOf(letter) >= 0 || guessBoard[4].indexOf(letter) >= 0}
    function create_if_block_2(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(82:6) {#if guessBoard[0].indexOf(letter) >= 0 || guessBoard[1].indexOf(letter) >= 0 || guessBoard[2].indexOf(letter) >= 0 || guessBoard[3].indexOf(letter) >= 0 || guessBoard[4].indexOf(letter) >= 0}",
    		ctx
    	});
    ...
    function create_else_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			button = element("button");
    			t = text(t_value);
    			attr_dev(button, "class", "alphi black svelte-g3rz42");
    			add_location(button, file, 87, 10, 2282);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, button, anchor);
    			append_dev(button, t);
    ...
    // (83:8) {#if wordle.includes(letter)}
    function create_if_block_3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			button = element("button");
    			t = text(t_value);
    			attr_dev(button, "class", "alphi aqua svelte-g3rz42");
    			add_location(button, file, 83, 10, 2158);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, button, anchor);
    			append_dev(button, t);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(83:8) {#if wordle.includes(letter)}",
    		ctx
    	});
    ...
    function create_each_block_2(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(81:4) {#each ALPHABET as letter}",
    		ctx
    	});
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			t = text(t_value);
    			attr_dev(div, "class", "guessI svelte-g3rz42");
    			attr_dev(div, "id", /*gi*/ ctx[21]);
    			add_location(div, file, 110, 12, 3150);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			t = text(t_value);
    			attr_dev(div, "class", "guessI yellow svelte-g3rz42");
    			attr_dev(div, "id", /*gi*/ ctx[21]);
    			add_location(div, file, 108, 12, 3058);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t);
    ...
    // (106:10) {#if guessBoard[gr][gi] === wordle[gi]}
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			t = text(t_value);
    			attr_dev(div, "class", "guessI green svelte-g3rz42");
    			attr_dev(div, "id", /*gi*/ ctx[21]);
    			add_location(div, file, 106, 12, 2895);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(106:10) {#if guessBoard[gr][gi] === wordle[gi]}",
    		ctx
    	});
    ...
    // (105:8) {#each guessRow as guessI, gi}
    function create_each_block_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(105:8) {#each guessRow as guessI, gi}",
    		ctx
    	});
    ...
    // (103:4) {#each guessBoard as guessRow, gr}
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t = space();
    			attr_dev(div, "class", "guessRow svelte-g3rz42");
    			attr_dev(div, "id", /*gr*/ ctx[18]);
    			add_location(div, file, 103, 6, 2763);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(103:4) {#each guessBoard as guessRow, gr}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h1, "class", "svelte-g3rz42");
    			add_location(h1, file, 78, 2, 1839);
    			attr_dev(div0, "class", "keyboard svelte-g3rz42");
    			add_location(div0, file, 79, 2, 1857);
    			attr_dev(button0, "id", "backButton");
    			attr_dev(button0, "type", "text");
    			attr_dev(button0, "class", "svelte-g3rz42");
    			add_location(button0, file, 98, 2, 2550);
    			attr_dev(button1, "id", "resetButton");
    			attr_dev(button1, "type", "text");
    			attr_dev(button1, "class", "svelte-g3rz42");
    			add_location(button1, file, 99, 2, 2618);
    			attr_dev(div1, "class", "gridContainer svelte-g3rz42");
    			add_location(div1, file, 101, 2, 2690);
    			attr_dev(main, "class", "svelte-g3rz42");
    			add_location(main, file, 77, 0, 1830);
    		},
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(button0, "click", /*undo*/ ctx[6], false, false, false),
