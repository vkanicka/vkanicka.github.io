    ...
    function create_else_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t = text(t_value);
    			attr_dev(button, "class", "alphi baseline svelte-92vfan");
    ...
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			button = element("button");
    			t = text(t_value);
    			attr_dev(button, "class", "alphi black svelte-92vfan");
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			t = text(t_value);
    			attr_dev(div, "class", "guessI svelte-92vfan");
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			t = text(t_value);
    			attr_dev(div, "class", "guessI yellow svelte-92vfan");
    			attr_dev(div, "id", /*gi*/ ctx[13]);
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			t = text(t_value);
    			attr_dev(div, "class", "guessI green svelte-92vfan");
    			attr_dev(div, "id", /*gi*/ ctx[13]);
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t = space();
    			attr_dev(div, "class", "guessRow svelte-92vfan");
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h1, "class", "svelte-92vfan");
    			add_location(h1, file, 24, 2, 519);
    			attr_dev(div0, "class", "keyboard svelte-92vfan");
    			add_location(div0, file, 26, 2, 582);
    			attr_dev(div1, "class", "gridContainer svelte-92vfan");
    			add_location(div1, file, 41, 2, 1143);
    			attr_dev(main, "class", "svelte-92vfan");
